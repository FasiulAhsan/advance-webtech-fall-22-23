...
class tourPackageController extends Controller
{
    ...
    public function savePackage(Request $request){
        ...
        $pack->save();
        return redirect ()->route('package-list')->with('success', 'Tour Package Added Successfully');
    ...
    public function updatePackage(Request $request){
        ...
        return redirect ()->route('package-list')->with('success', 'Tour Package Updated Successfully');
