					...
					<div class="col-md-6 col-lg-4">
						<div class="widget">
							...
							<ul class="list-unstyled quick-info links">
								...
								<li class="phone"><a href="#">+8801672297104</a></li>
								<li class="address"><a href="#">Kuril Bisshoroad, Dhaka-Bangladesh</a></li>
							</ul>
						</div>
					</div>
				</div>
	...
	<script>
		$(function() {
			...
			var typed = new Typed('.typed-words', {
				strings: ["Bandarban."," Shajek."," Cox's Bazar.", " Sundarban.", " Srimongol."],
				typeSpeed: 80,
				backSpeed: 80,
				backDelay: 4000,
				startDelay: 1000,
